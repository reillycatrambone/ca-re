...
A qualifying older-persons community's familial-status exemption does not authorize religious discrimination. A narrow owner-occupied exemption under one statute does not automatically remove advertising restrictions or the Civil Rights Act of 1866. The correct method is to identify the property, operator, activity, protected ground, and law, then ask whether that particular exemption reaches that particular conduct. Broad answers such as private owners may choose anyone usually skip several of these steps.
