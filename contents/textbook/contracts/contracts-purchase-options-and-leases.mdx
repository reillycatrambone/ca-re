...
sources:
  - label: Civil Code section 1662, default risk of loss before and after title or possession
    url: https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=1662.
  - label: Commercial Code section 1103, supplemental principles of law
    url: https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=COM&sectionNum=1103.
  - label: DRE real estate finance reference, notes and security instruments
    url: https://www.dre.ca.gov/files/pdf/refbook/ref12.pdf
  - label: Commercial Code section 3106, unconditional payment and permitted source limitations
    url: https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=COM&sectionNum=3106.
  - label: "CIV section 1638, clear contract language"
    url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=1638."
  - label: "CIV section 1585, absolute and qualified acceptance"
    url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=1585."
  - label: "CIV section 2985, real property sales contracts"
    url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=2985."
  - label: "DRE contracts reference"
    url: "https://www.dre.ca.gov/files/pdf/refbook/ref06.pdf"
  - label: "DRE landlord and tenant reference"
    url: "https://www.dre.ca.gov/files/pdf/refbook/ref09.pdf"
  - label: "DRE real estate financing reference"
    url: "https://www.dre.ca.gov/files/pdf/refbook/ref13.pdf"
  - label: "Commercial Code section 3112, fixed and variable interest"
    url: "https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=COM&sectionNum=3112."
...
| Stage when destruction or a taking occurs | Statutory consequence under the stated fault condition |
| --- | --- |
| Neither legal title nor possession has transferred; all or a material part is destroyed without the buyer's fault, or taken by eminent domain | The seller cannot enforce the purchase contract, and the buyer may recover the price already paid. |
| Either legal title or possession has transferred; all or any part is destroyed without the seller's fault, or taken by eminent domain | That event does not relieve the buyer of paying the price or entitle the buyer to recover payments. |

Early possession can therefore change the default result even before the deed transfers. Read an express risk-allocation clause before applying this statutory default. [Section 1662](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=1662.).
...
For the particular statutory category in **Civil Code section 2985**, the agreement does not require title conveyance within one year from formation. The section also excludes its specified attached-condominium contracts under a conditional public report. Do not classify an ordinary purchase closing in thirty days as this statutory arrangement simply because the buyer makes an initial deposit and a later payment. [Section 2985](https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=2985.).
