...
A missed payment may permit acceleration under the note and security instrument, subject to applicable protections. Acceleration means the lender can declare the remaining debt due. It does not mean a trustee may disregard notices, waiting periods, or other foreclosure requirements. Likewise, a due-on-sale clause creates rights concerning covered transfers, but lawful exceptions and the actual transaction must be considered before concluding that acceleration is permitted.

Reinstatement and payoff answer different demands. Reinstatement generally addresses the delinquent amounts and allowable charges needed to restore the loan within the applicable period. Full payoff satisfies the outstanding obligation. A borrower with enough cash to cure missed installments may not have enough to pay the entire principal. Do not treat these as equivalent simply because both can stop a pending enforcement problem in an appropriate situation.
