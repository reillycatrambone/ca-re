...
sources:
  - label: California BOE, Advanced Appraisal, paired-sales analysis
    url: https://www.boe.ca.gov/proptaxes/pdf/ah502.pdf
...
**Finished lots are not an undeveloped tract.** If a purchaser would divide a large tract into smaller parcels, the retail lot prices need allowances for subdivision costs, street and alley area, selling expenses, normal profit, and interest during marketing. [BOE Rule 4(d)](https://www.boe.ca.gov/proptaxes/pdf/rules/Rule4.pdf).
